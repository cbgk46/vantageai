      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/case-studies" className="text-primary-600 hover:text-accent-400 transition-colors">
              Case Studies
            </Link>
            <Link href="/about" className="text-primary-600 hover:text-accent-400 transition-colors">
              About
            </Link>
            <Link href="/assessment" className="btn-primary text-sm px-6 py-2.5">
              Free Assessment
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-primary-200">
            <div className="flex flex-col space-y-4">
              ...
              <Link href="/assessment" className="btn-primary text-sm px-6 py-2.5 w-fit">
                Free Assessment
              </Link>
            </div>
          </div>
